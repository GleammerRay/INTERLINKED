...
'},' +
'{' +
  `"name":"subscribe","type":1,"description":"${subscribeDesc}","default_member_permissions":"0"` +
'},' +
'{' +
  `"name":"unsubscribe","type":1,"description":"${unsubscribeDesc}","default_member_permissions":"0"` + 
'},' + 
'{' +
...
'},' +
'{' +
  `"name":"reset","type":1,"description":"${resetDesc}","default_member_permissions":"0"` +
'},' +
'{' +
...
'},' +
'{' +
  `"name":"set","type":1,"description":"${setDesc}","default_member_permissions":"0","options":[` +
...
'},' +
'{' +
  `"name":"remove","type":1,"description":"${removeDesc}","default_member_permissions":"0","options":[` +
    `{"name":"ping_role","type":1,"description":"${pingRoleDesc}"}` +
  ']' +
'}' +
']');
