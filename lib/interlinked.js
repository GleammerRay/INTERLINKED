...
export class Interlinked {
  ...
  constructor(
    ...
    this.#discord = InterlinkedDiscord.fromJSON(discordPrefs, this.#rest, config.gameName, images, onSave, onLog);
  ...
  static getServerRequestURL(steamAPIKey, steamAppID, steamGameDir) {
    ...
    return `https://api.steampowered.com/IGameServersService/GetServerList/v1/?key=${steamAPIKey}&filter=${_filter}&limit=15`;
  }
  ...
  async updateSteamServers() {
    ...
    if (this.#outputTopServersHTMLPath != null) {
      var topServersHTML = webtoys.generateTopServersHTML(this.#gameName, this.#servers, this.#topServersHTMLStyle);
