...
export class Interlinked {
  ...
  constructor(
    ...
    if (this.#outputEmbedJSONPath != null) {
      this.#embedGeneratorGuild = new InterlinkedGuild(null, this.#rest, this.#gameName, images, this.#onLog);
    }
  }
  ...
  async updateSteamServers() {
    ...
    if (this.#outputEmbedJSONPath != null) {
      fs.writeFileSync(this.#outputEmbedJSONPath, this.#embedGeneratorGuild.buildServerListMessage(this.#servers));
    }
  }
