...
export class InterlinkedDiscord {
  ...
  getOrSetGuild(guildID) {
    if (!(guildID in this.#guilds)) {
      var _guild = new InterlinkedGuild(guildID, this.#rest, this.#gameName, this.#images, this.#onLog, defaultMaxServerCount, null, [], defaultSubscriptionFeedMinRate, defaultMinPlayerCount, null, defaultPingMinRate, defaultPingMinPlayerCount, [], null, null, null, null, this.logoURL);
