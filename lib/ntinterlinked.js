...
'"author":{"name":"INTERLINKED","url":"https://github.com/GleammerRay/NTInterlinked","icon_url": "https://github.com/GleammerRay/NTInterlinked/blob/main/assets/logo.png?raw=true"},' +
'"description":"' +
`\`/help\` - ${helpDesc}\\n` +
`\`/update\` - ${updateDesc}\\n` +
...
export class Interlinked {
  ...
  async updateSteamServers() {
    this.#ntServers = NTServerList.fromSteamServers((await this.getSteamServers()).response.servers);
  }
